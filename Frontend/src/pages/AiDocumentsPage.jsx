...
import { Upload, FileText, Search, Plus, Trash2, Folder, Sparkles, BookOpen, Clock } from "lucide-react";
...
export default function AiDocumentsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0b1120] text-gray-900 dark:text-gray-100 p-8 pt-20">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-10">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-2">
              Upload documents, books, or notes to chat and learn interactively.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            <div className="relative flex-1 sm:w-64">
              ...
              <input 
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:outline-none transition-shadow"
              />
            </div>
            
            <label className="cursor-pointer bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2.5 rounded-xl font-semibold flex items-center gap-2 transition-colors shadow-sm whitespace-nowrap">
              {isUploading ? (
        ...
        {loading ? (
          ...
          <div className="text-center py-24 bg-white dark:bg-gray-800/50 rounded-2xl border border-gray-200 dark:border-gray-800 border-dashed">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-6">Upload a PDF or document to get started</p>
            <label className="cursor-pointer text-indigo-600 font-semibold hover:underline">
              Browse Files
