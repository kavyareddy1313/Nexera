  ...
  return (
    <div className="flex flex-1 overflow-hidden bg-[#f8f9fc]">
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        {/* Top Header */}
        <header className="h-[72px] bg-white flex items-center justify-between px-8 shrink-0">
          <h1 className="text-[19px] font-extrabold text-indigo-700 tracking-tight">Nexera Academy</h1>
          ...
          <div className="flex items-center gap-6">
            <div className="relative w-64">
              ...
              <input 
                type="text" 
                placeholder="Search..." 
                className="w-full bg-gray-50 border-none rounded-full py-2 pl-9 pr-4 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-indigo-100"
              />
            </div>
            <button className="text-gray-500 hover:text-gray-700 transition-colors"><Bell size={20} /></button>
            <button className="text-gray-500 hover:text-gray-700 transition-colors"><HelpCircle size={20} /></button>
            <button className="text-sm font-bold text-indigo-600 hover:text-indigo-700 transition-colors">Create Course</button>
